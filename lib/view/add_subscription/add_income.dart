...
Future<void> _addIncome() async {
  try {
    ...
    if (cardSnapshot.exists) {
      ...
      double addedValue = double.tryParse(_valueController.text) ?? 0.0;

      double newBalance = currentBalance + addedValue;
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Income added and card balance updated successfully')),
    );
...
void showCategoryModal(BuildContext context) async {
  List<Map<String, dynamic>> categories = await fetchCategoriesFromFirestore("income");
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              textAlign: TextAlign.center, // Căn giữa nội dung chữ
              decoration: InputDecoration(
                hintText: 'Description your income',
                hintStyle: TextStyle(
                  color: Color(0xFF8C8C9D),
